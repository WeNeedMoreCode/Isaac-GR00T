    ...
    def __init__(
        ...
        *,
        ...
        if backbone_path:
            ...
            model = AutoModel.from_pretrained(model_dir, config=_cfg, **load_kwargs)
        else:
        ...
        # Override processor's model_name to use local backbone path
        processor_kwargs = {}
        if backbone_path and is_npu:
            processor_kwargs["model_name"] = backbone_path
